// Refer to my thread if you would like to know how to load configs.
CONFIG = JSON.parse('{"2TN": 0, "M2w": 1, "Yae": 3, "P78": 1, "VSj": 1, "tGb": 1, "Fp6": 0, "5jF": 28, "E3u": 2, "3xM": 0, "8xh": 0, "kK6": 0, "XxD": 1, "VM2": 30, "2ya": 10, "RG4": 15, "EB3": 1, "G8C": 3, "ke2": 15, "xN8": 1, "au2": 65, "9bf": 2, "z5T": 1, "8Hx": 1}');
...
/******************************** FUNCTIONS ********************************/
function onDraw() {
	if (Entity.IsAlive(local) && options[UI.GetValue("menu type")].showArrows.toggled && options[UI.GetValue("menu type")].style.memory.selected != 2) {
...
options[1].freq = new Slider(196, menu, true, [3, 0, "cycle frequency"], "kK6", function() {}, {min: 0, max: 100});
